...
echo "Run baseline CCAs' file download experiments..."
cleanup
cca=$1
echo "Running experiments for CCA: $cca"
setup
run_all_traces
cleanup
echo "Finished experiments for CCA: $cca, waiting for 2 minutes before next CCA..."
echo "Run baseline test finish" && exit 1
